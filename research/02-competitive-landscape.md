...
**Status relative to CTS:** CTS's L2 is a specified, external, exchange-mandated standard for how anti-whale mechanisms must be implemented and governed. It requires supermajority governance vote to modify and automated verification. This is categorically different from a coin implementing its own informal cap.

---

## Summary Table

| Tool / Standard | L1: Liquidity Lock | L2: Anti-Whale | L3: On-Chain Verify | L4: ID Registry | Exchange Mandate | Bundled Standard |
|----------------|:-:|:-:|:-:|:-:|:-:|:-:|
