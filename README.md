...
- The technical specification for all four layers (coming soon)
- The TrustRegistry smart contract specification (coming soon)
- The public Safety Scorecard (coming soon)
...
| `SPEC.md` *(coming soon)* | Technical specification for the four layers |
| `TrustRegistry.sol` *(coming soon)* | Smart contract specification |
| `SCORECARD.md` *(coming soon)* | Public coin safety scores |
...
The TrustRegistry smart contract code will be published under MIT License.
